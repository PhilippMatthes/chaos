...
import (
	...
	"github.com/philippmatthes/chaos/internal/controller"
...
func init() {
	...
	utilruntime.Must(chaosv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "7bb51aff.chaos.philippmatthes",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = (&chaosv1.Chaos{}).SetupWebhookWithManager(mgr); err != nil {
